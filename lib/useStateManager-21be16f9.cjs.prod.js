...
var index = require("./index-554e531b.cjs.prod.js"), _slicedToArray = require("@babel/runtime/helpers/slicedToArray"), _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), React = require("react");
...
function useStateManager(_ref) {
  var _ref$defaultInputValu = _ref.defaultInputValue, defaultInputValue = void 0 === _ref$defaultInputValu ? "" : _ref$defaultInputValu, _ref$defaultMenuIsOpe = _ref.defaultMenuIsOpen, defaultMenuIsOpen = void 0 !== _ref$defaultMenuIsOpe && _ref$defaultMenuIsOpe, _ref$defaultValue = _ref.defaultValue, defaultValue = void 0 === _ref$defaultValue ? null : _ref$defaultValue, propsInputValue = _ref.inputValue, propsMenuIsOpen = _ref.menuIsOpen, propsOnChange = _ref.onChange, propsOnInputChange = _ref.onInputChange, propsOnMenuClose = _ref.onMenuClose, propsOnMenuOpen = _ref.onMenuOpen, propsValue = _ref.value, restSelectProps = _objectWithoutProperties__default.default(_ref, _excluded), stateInputValue = React.useMemo((function() {
    return void 0 !== propsInputValue ? propsInputValue : defaultInputValue;
  }), [ propsInputValue, defaultInputValue ]), _useState = React.useState(void 0 !== propsMenuIsOpen ? propsMenuIsOpen : defaultMenuIsOpen), _useState2 = _slicedToArray__default.default(_useState, 2), stateMenuIsOpen = _useState2[0], setStateMenuIsOpen = _useState2[1], stateValue = React.useMemo((function() {
    return void 0 !== propsValue ? propsValue : defaultValue;
  }), [ propsValue, defaultValue ]), onChange = React.useCallback((function(value, actionMeta) {
    ...
    "function" == typeof propsOnInputChange && propsOnInputChange(value, actionMeta);
