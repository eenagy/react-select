import { ActionMeta, GroupBase, InitialInputFocusedActionMeta, OnChangeValue, OptionBase, Options, OptionsOrGroups } from '../types';
...
export declare type AriaSelection<Option extends OptionBase, IsMulti extends boolean> = InitialInputFocusedActionMeta<Option, IsMulti> | (ActionMeta<Option> & {
