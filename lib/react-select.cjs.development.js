...
var cleanCommonProps = function cleanCommonProps(props) {
  //className
  var innerProps = _objectWithoutPropertiesLoose(props, _excluded);
...
var Menu = function Menu(props) {
  ...
  return react.jsx("div", Object.assign({
...
var MenuPortal = /*#__PURE__*/function (_Component2) {
  ...
  _proto2.render = function render() {
    ...
    var menuWrapper = react.jsx("div", Object.assign({
...
var A11yText = function A11yText(props) {
  return react.jsx("span", Object.assign({
    css: {
      label: 'a11yText',
      zIndex: 9999,
      border: 0,
...
var defaultAriaLiveMessages = {
  guidance: function guidance(props) {
    ...
    switch (context) {
      ...
      case 'input':
        return (props['aria-label'] || 'Select') + " is focused " + (isSearchable ? ',type to refine list' : '') + ", press Down to open the menu, " + (isMulti ? ' press left to focus selected values' : '');
  ...
  onFocus: function onFocus(props) {
    ...
    var getArrayIndex = function getArrayIndex(arr, item) {
      return arr && arr.length ? arr.indexOf(item) + 1 + " of " + arr.length : '';
    };
    ...
    if (context === 'menu') {
      ...
      var status = "" + (isSelected ? 'selected' : 'focused') + disabled;
...
var LiveRegion = function LiveRegion(props) {
  ...
  var messages = React.useMemo(function () {
    return _extends({}, defaultAriaLiveMessages, ariaLiveMessages || {});
  ...
  var ariaContext = ariaFocused + " " + ariaResults + " " + ariaGuidance;
  var ScreenReaderText = react.jsx(React__default.Fragment, null, react.jsx("span", {
    id: "aria-selection"
  }, ariaSelected), react.jsx("span", {
    id: "aria-context"
  }, ariaContext));
  var isInitialFocus = (ariaSelection == null ? void 0 : ariaSelection.action) === 'initial-input-focus';
  return react.jsx(React__default.Fragment, null, react.jsx(A11yText, {
    id: id
...
var anyDiacritic = /*#__PURE__*/new RegExp('[' + /*#__PURE__*/diacritics.map(function (d) {
  return d.letters;
}).join('') + ']', 'g');
var diacriticToBase = {};
...
var memoizedStripDiacriticsForInput = /*#__PURE__*/memoizeOne(stripDiacritics);
...
function DummyInput(_ref) {
  ...
  return react.jsx("input", Object.assign({
    ref: innerRef
  }, props, {
    css: {
      label: 'dummyInput',
...
var Svg = function Svg(_ref) {
  ...
  return react.jsx("svg", Object.assign({
    height: size,
    width: size,
    viewBox: "0 0 20 20",
    "aria-hidden": "true",
...
var IndicatorSeparator = function IndicatorSeparator(props) {
  var className = props.className,
      ...
      getStyles = props.getStyles,
      innerProps = props.innerProps;
  return react.jsx("span", Object.assign({}, innerProps, {
...
var loadingDotAnimations = /*#__PURE__*/react.keyframes(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  0%, 80%, 100% { opacity: 0; }\n  40% { opacity: 1; }\n"])));
...
var Group = function Group(props) {
  ...
  }, innerProps), react.jsx(Heading, Object.assign({}, headingProps, {
...
var GroupHeading = function GroupHeading(props) {
  ...
  var _cleanCommonProps = cleanCommonProps(props),
      innerProps = _objectWithoutPropertiesLoose(_cleanCommonProps, _excluded$3);
...
var Input = function Input(props) {
  ...
  var _cleanCommonProps = cleanCommonProps(props),
      ...
      innerProps = _objectWithoutPropertiesLoose(_cleanCommonProps, _excluded$4);
...
var MultiValueGeneric = function MultiValueGeneric(_ref4) {
  ...
  return react.jsx("div", Object.assign({}, innerProps), children);
};
...
var defaultProps = {
  ...
  blurInputOnSelect: /*#__PURE__*/isTouchCapable(),
  captureMenuScroll: ! /*#__PURE__*/isTouchCapable(),
  closeMenuOnSelect: true,
  closeMenuOnScroll: false,
  components: {},
  controlShouldRenderValue: true,
  escapeClearsValue: false,
  filterOption: /*#__PURE__*/createFilter(),
  ...
  menuShouldScrollIntoView: ! /*#__PURE__*/isMobileDevice(),
...
function buildFocusableOptionsFromCategorizedOptions(categorizedOptions) {
  return categorizedOptions.reduce(function (optionsAccumulator, categorizedOption) {
    if (categorizedOption.type === 'group') {
      optionsAccumulator.push.apply(optionsAccumulator, categorizedOption.options.map(function (option) {
        return option.data;
      }));
    } else {
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(props) {
    ...
    _this.scrollToFocusedOptionOnUpdate = false; // Refs
    // ------------------------------
    ...
    _this.selectOption = function (newValue) {
      ...
      if (deselected) {
        ...
        if (isMulti) {
          _this.setValue(multiValueAsValue([].concat(selectValue, [newValue])), 'select-option', newValue);
        } else {
    ...
    _this.state.selectValue = cleanValue(props.value);
    return _this;
  }
  ...
  Select.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    if ((ariaSelection == null ? void 0 : ariaSelection.action) === 'initial-input-focus') {
      newAriaSelection = null;
    }

    return _extends({}, newMenuOptionsState, newInputIsHiddenState, {
      prevProps: props,
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    isFocused && !isDisabled && prevProps.isDisabled || isFocused && menuIsOpen && !prevProps.menuIsOpen) {
      this.focusInput();
    }
  ...
  _proto.renderInput = function renderInput() {
    ...
    if (!isSearchable) {
      ...
      return React__default.createElement(DummyInput, Object.assign({
        id: id,
    ...
    return React__default.createElement(Input, Object.assign({}, commonProps, {
      autoCapitalize: "none",
      autoComplete: "off",
      autoCorrect: "off",
      id: id,
  ...
  _proto.renderPlaceholderOrValue = function renderPlaceholderOrValue() {
    ...
    if (!this.hasValue() || !controlShouldRenderValue) {
      return inputValue ? null : React__default.createElement(Placeholder, Object.assign({}, commonProps, {
        key: "placeholder",
        isDisabled: isDisabled,
        isFocused: isFocused,
        innerProps: {
    ...
    if (isMulti) {
      return selectValue.map(function (opt, index) {
        ...
        return React__default.createElement(MultiValue, Object.assign({}, commonProps, {
          components: {
          ...
          isDisabled: isDisabled,
          key: "" + _this3.getOptionValue(opt) + index,
          index: index,
          removeProps: {
    ...
    return React__default.createElement(SingleValue, Object.assign({}, commonProps, {
      data: singleValue,
      isDisabled: isDisabled
  ...
  _proto.renderClearIndicator = function renderClearIndicator() {
    ...
    return React__default.createElement(ClearIndicator, Object.assign({}, commonProps, {
  ...
  _proto.renderLoadingIndicator = function renderLoadingIndicator() {
    ...
    return React__default.createElement(LoadingIndicator, Object.assign({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderIndicatorSeparator = function renderIndicatorSeparator() {
    ...
    var isFocused = this.state.isFocused;
    return React__default.createElement(IndicatorSeparator, Object.assign({}, commonProps, {
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  };
  ...
  _proto.renderDropdownIndicator = function renderDropdownIndicator() {
    ...
    return React__default.createElement(DropdownIndicator, Object.assign({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    var render = function render(props, id) {
      ...
      var optionId = _this4.getElementId('option') + "-" + id;
      var innerProps = {
        id: optionId,
        onClick: onSelect,
        onMouseMove: onHover,
      ...
      return React__default.createElement(Option, Object.assign({}, commonProps, {
        innerProps: innerProps,
        data: data,
        isDisabled: isDisabled,
        isSelected: isSelected,
    ...
    if (this.hasOptions()) {
      menuUI = this.getCategorizedOptions().map(function (item) {
        if (item.type === 'group') {
          ...
          var groupId = _this4.getElementId('group') + "-" + groupIndex;
          var headingId = groupId + "-heading";
          return React__default.createElement(Group, Object.assign({}, commonProps, {
            key: groupId,
            data: data,
            options: options,
      ...
      menuUI = React__default.createElement(LoadingMessage, Object.assign({}, commonProps), message);
    } else {
      ...
      menuUI = React__default.createElement(NoOptionsMessage, Object.assign({}, commonProps), _message);
    }
    ...
    var menuElement = React__default.createElement(MenuPlacer, Object.assign({}, commonProps, menuPlacementProps), function (_ref4) {
      var ref = _ref4.ref,
          _ref4$placerProps = _ref4.placerProps,
          placement = _ref4$placerProps.placement,
          maxHeight = _ref4$placerProps.maxHeight;
      return React__default.createElement(Menu, Object.assign({}, commonProps, menuPlacementProps, {
        innerRef: ref,
        innerProps: {
        ...
        return React__default.createElement(MenuList, Object.assign({}, commonProps, {
    ...
    return menuPortalTarget || menuPosition === 'fixed' ? React__default.createElement(MenuPortal, Object.assign({}, commonProps, {
  ...
  _proto.renderLiveRegion = function renderLiveRegion() {
    ...
    return React__default.createElement(LiveRegion, Object.assign({}, commonProps, {
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement(SelectContainer, Object.assign({}, commonProps, {
      className: className,
      innerProps: {
        id: id,
      ...
      isDisabled: isDisabled,
      isFocused: isFocused
    }), this.renderLiveRegion(), React__default.createElement(Control, Object.assign({}, commonProps, {
    ...
    }), React__default.createElement(ValueContainer, Object.assign({}, commonProps, {
      isDisabled: isDisabled
    }), this.renderPlaceholderOrValue(), this.renderInput()), React__default.createElement(IndicatorsContainer, Object.assign({}, commonProps, {
      isDisabled: isDisabled
...
function useStateManager(_ref) {
  var _ref$defaultInputValu = _ref.defaultInputValue,
      ...
      restSelectProps = _objectWithoutPropertiesLoose(_ref, _excluded$5);
  ...
  var _useState = React.useState(propsMenuIsOpen !== undefined ? propsMenuIsOpen : defaultMenuIsOpen),
      stateMenuIsOpen = _useState[0],
      setStateMenuIsOpen = _useState[1];
  ...
  return _extends({}, restSelectProps, {
    inputValue: inputValue,
    menuIsOpen: menuIsOpen,
    onChange: onChange,
...
var StateManagedSelect = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
